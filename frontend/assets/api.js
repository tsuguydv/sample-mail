...
const API = (() => {
  ...
  async function getContactLists(){
    return await request("/api/contacts/lists");
  }
  ...
  async function deleteContactList(id){
    return await request("/api/contacts/lists/" + encodeURIComponent(id), { method: "DELETE" });
  }

  async function getListContacts(id){
    return await request("/api/contacts/lists/" + encodeURIComponent(id) + "/contacts");
  }

  async function uploadContacts(data){
    return await request("/api/contacts/upload", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
    });
  ...
  async function getCampaignStats(){
    return await request("/api/analytics/campaigns");
  }

  async function sendContactsCampaign(data){
    return await request("/api/contacts/send-campaign", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
    });
  ...
  return {
    ...
    getContactLists, createContactList, deleteContactList, getListContacts, uploadContacts, sendContactsCampaign,
    getCampaignStats,
  };
})();
