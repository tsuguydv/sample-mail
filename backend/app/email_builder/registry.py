...
DESIGN_DEFAULTS: Context = {
    ...
    "brand_url": "#",
    "preheader": "Письмо, созданное в smart-letters",
...
BLOCK_REGISTRY: dict[str, BlockMetadata] = {
    "header": BlockMetadata(
        ...
        {
            "logo_text": "smart-letters",
            "tagline": "Генерация email с ИИ",
            "view_url": "#",
    ...
    "hero": BlockMetadata(
        ...
        {
            "eyebrow": "smart-letters",
            "title": "Ваше письмо готово",
            "subtitle": "Текст и оформление созданы с помощью ИИ — отредактируйте блоки перед отправкой.",
            "button_text": "Подробнее",
            "button_url": "#",
            "image_url": "https://placehold.co/560x240/4f46e5/ffffff?text=smart-letters",
        },
    ),
    "text": BlockMetadata(
        "text",
        ...
        {
            "title": "О вашем предложении",
            "paragraphs": [
                "Этот текст будет сгенерирован ИИ на основе данных вашей компании и темы письма.",
                "Вы сможете изменить формулировки в редакторе перед экспортом.",
            ],
        },
    ),
    "hero_split": BlockMetadata(
        ...
        },
        {
            ...
            "button_text": "Открыть",
            "button_url": "#",
            "image_url": "https://placehold.co/260x220/4f46e5/ffffff?text=Preview",
            "image_alt": "Preview",
        },
    ),
    ...
    "benefits": BlockMetadata(
        ...
        },
        {
            ...
            "benefits": [
                ...
                {"title": "Быстрый старт", "text": "Выберите блоки, сгенерируйте текст и скачайте HTML для рассылки."},
            ],
        },
    ),
    ...
    "faq": BlockMetadata(
        ...
        {"title": "Заголовок.", "items": "Список объектов question, answer."},
        {
            "title": "Вопросы",
            "items": [
                {"question": "Можно ли менять блоки?", "answer": "Да — соберите макет в конструкторе, затем сгенерируйте текст с ИИ в smart-letters."},
            ],
        },
    ),
