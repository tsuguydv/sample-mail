...
window.I18N = {
  ru: {
    ...
    "page.title.contacts": "smart-letters — Контакты",
    "page.title.campaigns": "smart-letters — Кампании",
    "page.title.analytics": "smart-letters — Аналитика",
    ...
    "templates.section.myTemplates": "Мои шаблоны",
    "templates.section.platform": "Шаблоны платформы",
    ...
    "params.hint": "<strong>Параметры письма:</strong> о чём писать в письме, пожелания к дизайну, ссылка для кнопки в письме.",
    "params.label.subject": "О чём писать письмо *",
    "params.label.imageWishes": "Пожелания к дизайну письма",
    "params.label.ctaLink": "Ссылка для кнопки в письме",
    "params.placeholder.subject": "Опишите своими словами, что должно быть в письме: идея, ключевые тезисы, аудитория…",
    "params.placeholder.imageWishes": "Стиль, цвета, тон, настроение",
    ...
    "contacts.subtitle": "Загрузка контактов из CSV в ваши списки рассылки.",
    "contacts.noSendgrid": "Провайдер рассылки не настроен на сервере.",
    "contacts.listsTitle": "Списки рассылки",
    "contacts.refresh": "Обновить",
    "contacts.loading": "Загрузка…",
    "contacts.noLists": "Списки рассылки не найдены.",
    "contacts.col.name": "Название списка",
    "contacts.col.id": "ID",
    "contacts.col.existing": "Уже в списке",
    "contacts.col.csv": "CSV-файл",
    "contacts.col.parsed": "Распознано",
    "contacts.col.uploaded": "Загружено",
    "contacts.col.total": "Всего",
    "contacts.col.batches": "Партий",
    "contacts.col.errors": "Ошибки",
    "contacts.upload": "Загрузить контакты",
    "contacts.resultsTitle": "Результаты загрузки",
    "contacts.chooseFile": "Выбрать файл",
    "contacts.confirm": "Загрузить выбранные контакты?",
    "contacts.uploading": "Загрузка…",
    "contacts.done": "Готово",
    "contacts.error.load": "Не удалось загрузить списки",
    "contacts.error.upload": "Не удалось загрузить контакты",
    "contacts.newList": "+ Новый список",
    "contacts.deleteListTitle": "Удалить список",
    "contacts.listNamePrompt": "Название списка?",
    "contacts.deleteConfirm": "Удалить этот список и его контакты?",
    "contacts.parseError": "Ошибка разбора CSV: ",
    "contacts.saved": "{n} сохранено",
    "contacts.contactsCount": "{n} контактов",
    "contacts.more": "… и ещё {n}",
    "campaigns.title": "Отправка рассылки",
    "campaigns.subtitle": "Отправка созданного письма в список контактов.",
    "campaigns.formTitle": "Параметры рассылки",
    "campaigns.info": "Письмо будет немедленно отправлено всем контактам выбранного списка. Убедитесь, что адрес отправителя подтверждён у провайдера рассылки.",
    "campaigns.label.email": "Созданное письмо",
    "campaigns.placeholder.email": "— Загрузка писем… —",
    "campaigns.label.list": "Список контактов",
    "campaigns.placeholder.list": "— Загрузка списков… —",
    "campaigns.label.subject": "Тема",
    "campaigns.label.sender": "Отправитель",
    "campaigns.send": "Отправить рассылку",
    "campaigns.senderVerified": "✓ Отправитель подтверждён",
    "campaigns.senderNotVerified": "⚠ Отправитель не подтверждён — подтвердите его у провайдера рассылки",
    "campaigns.selectList": "— Выберите список —",
    "campaigns.noLists": "Списки контактов не найдены",
    "campaigns.errEmails": "Ошибка загрузки писем",
    "campaigns.errLists": "Ошибка загрузки списков",
    "campaigns.loadEmailsErr": "Не удалось загрузить письма: ",
    "campaigns.loadListsErr": "Не удалось загрузить списки контактов: ",
    "campaigns.sendConfirm": "Отправить рассылку в список «{name}»?\n\nПисьмо уйдёт немедленно всем контактам списка.",
    "analytics.title": "Аналитика рассылок",
    "analytics.subtitle": "Статистика эффективности рассылок.",
    "analytics.chart.rates": "Доля открытий и кликов по рассылкам",
    "analytics.chart.funnel": "Воронка (все рассылки)",
    "analytics.tableTitle": "Детализация по рассылкам",
    "analytics.col.name": "Рассылка",
    "analytics.col.status": "Статус",
    "analytics.col.date": "Дата",
    "analytics.col.sent": "Отправлено",
    "analytics.col.delivered": "Доставлено",
    "analytics.col.uOpens": "Уник. открытия",
    "analytics.col.openRate": "% открытий",
    "analytics.col.uClicks": "Уник. клики",
    "analytics.col.clickRate": "% кликов",
    "analytics.col.bounces": "Отказы",
    "analytics.col.unsubs": "Отписки",
    "analytics.noCampaigns": "Рассылки не найдены.",
    "analytics.noEventsHint": "Метрики появляются после отправки рассылки и подтягиваются с небольшой задержкой (статистика опрашивается у SendGrid).",
    "analytics.summary.campaigns": "Рассылки",
    "analytics.summary.sent": "Отправлено",
    "analytics.summary.delivered": "Доставлено",
    "analytics.summary.uOpens": "Уник. открытия",
    "analytics.summary.uClicks": "Уник. клики",
    "analytics.summary.bounces": "Отказы",
    "analytics.summary.unsubs": "Отписки",
    "analytics.summary.sub.total": "всего",
    "analytics.summary.sub.emails": "писем",
    "analytics.summary.sub.openRate": "открытий",
    "analytics.summary.sub.clickRate": "кликов",
    "analytics.status.sent": "отправлено",
    "analytics.status.scheduled": "запланировано",
    "analytics.status.sending": "отправляется",
    "analytics.status.queued": "в очереди",
    "analytics.status.error": "ошибка",
    "analytics.status.draft": "черновик",
  },
  en: {
    ...
    "page.title.contacts": "smart-letters — Contacts",
    "page.title.campaigns": "smart-letters — Campaigns",
    "page.title.analytics": "smart-letters — Analytics",
    ...
    "templates.section.myTemplates": "My templates",
    "templates.section.platform": "Platform templates",
    ...
    "params.hint": "<strong>Email parameters:</strong> what to write about, design preferences, link for the button.",
    "params.label.subject": "What to write about *",
    "params.label.imageWishes": "Email design preferences",
    "params.label.ctaLink": "Link for the button",
    "params.placeholder.subject": "Describe in your own words what the email should say: main idea, key points, audience…",
    "params.placeholder.imageWishes": "Style, colors, tone, mood",
    "params.placeholder.cta": "https://…",
    ...
    "contacts.subtitle": "Upload CSV contacts into your mailing lists.",
    "contacts.noSendgrid": "The mailing provider is not configured on the server.",
    "contacts.listsTitle": "Mailing lists",
    "contacts.refresh": "Refresh",
    "contacts.loading": "Loading…",
    "contacts.noLists": "No mailing lists found.",
    "contacts.col.name": "List name",
    "contacts.col.id": "ID",
    "contacts.col.existing": "Existing",
    "contacts.col.csv": "CSV file",
    "contacts.col.parsed": "Parsed",
    "contacts.col.uploaded": "Uploaded",
    "contacts.col.total": "Total",
    "contacts.col.batches": "Batches",
    "contacts.col.errors": "Errors",
    "contacts.upload": "Upload contacts",
    "contacts.resultsTitle": "Upload Results",
    "contacts.chooseFile": "Choose file",
    "contacts.confirm": "Upload the selected contacts?",
    "contacts.uploading": "Uploading…",
    "contacts.done": "Done",
    "contacts.error.load": "Failed to load lists",
    "contacts.error.upload": "Failed to upload contacts",
    "contacts.newList": "+ New list",
    "contacts.deleteListTitle": "Delete list",
    "contacts.listNamePrompt": "List name?",
    "contacts.deleteConfirm": "Delete this list and its contacts?",
    "contacts.parseError": "CSV parse error: ",
    "contacts.saved": "{n} saved",
    "contacts.contactsCount": "{n} contacts",
    "contacts.more": "… and {n} more",
    "campaigns.title": "Send Campaign",
    "campaigns.subtitle": "Send a generated email to a contact list.",
    "campaigns.formTitle": "Campaign Settings",
    "campaigns.info": "The email will be sent immediately to all contacts in the selected list. Make sure your sender email is verified with your mailing provider.",
    "campaigns.label.email": "Generated Email",
    "campaigns.placeholder.email": "— Loading emails… —",
    "campaigns.label.list": "Contact List",
    "campaigns.placeholder.list": "— Loading lists… —",
    "campaigns.label.subject": "Subject",
    "campaigns.label.sender": "Sender",
    "campaigns.send": "Send Campaign",
    "campaigns.senderVerified": "✓ Sender verified",
    "campaigns.senderNotVerified": "⚠ Sender not verified — confirm it with your mailing provider",
    "campaigns.selectList": "— Select a list —",
    "campaigns.noLists": "No contact lists found",
    "campaigns.errEmails": "Error loading emails",
    "campaigns.errLists": "Error loading lists",
    "campaigns.loadEmailsErr": "Failed to load emails: ",
    "campaigns.loadListsErr": "Failed to load contact lists: ",
    "campaigns.sendConfirm": "Send campaign to list \"{name}\"?\n\nThis will send immediately to all contacts in the list.",
    "analytics.title": "Email Analytics",
    "analytics.subtitle": "Campaign performance statistics.",
    "analytics.chart.rates": "Open Rate & Click Rate by Campaign",
    "analytics.chart.funnel": "Total Funnel (all campaigns)",
    "analytics.tableTitle": "Campaign Details",
    "analytics.col.name": "Campaign",
    "analytics.col.status": "Status",
    "analytics.col.date": "Date",
    "analytics.col.sent": "Sent",
    "analytics.col.delivered": "Delivered",
    "analytics.col.uOpens": "Uniq. Opens",
    "analytics.col.openRate": "Open %",
    "analytics.col.uClicks": "Uniq. Clicks",
    "analytics.col.clickRate": "Click %",
    "analytics.col.bounces": "Bounces",
    "analytics.col.unsubs": "Unsubs",
    "analytics.noCampaigns": "No campaigns found.",
    "analytics.noEventsHint": "Metrics appear after a campaign is sent, with a short delay (stats are polled from SendGrid).",
    "analytics.summary.campaigns": "Campaigns",
    "analytics.summary.sent": "Sent",
    "analytics.summary.delivered": "Delivered",
    "analytics.summary.uOpens": "Unique Opens",
    "analytics.summary.uClicks": "Unique Clicks",
    "analytics.summary.bounces": "Bounces",
    "analytics.summary.unsubs": "Unsubscribes",
    "analytics.summary.sub.total": "total",
    "analytics.summary.sub.emails": "emails",
    "analytics.summary.sub.openRate": "open rate",
    "analytics.summary.sub.clickRate": "click rate",
    "analytics.status.sent": "sent",
    "analytics.status.scheduled": "scheduled",
    "analytics.status.sending": "sending",
    "analytics.status.queued": "queued",
    "analytics.status.error": "error",
